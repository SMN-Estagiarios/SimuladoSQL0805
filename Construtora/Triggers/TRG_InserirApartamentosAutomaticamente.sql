CREATE OR ALTER TRIGGER [dbo].[TRG_InserirApartamentosAutomaticamente]
	...
	/*
		...
		Objetivo........: Cria os registros de apartamentos assim que um prédio é inserido
					...
					BEGIN
						...
						IF @@ERROR <> 0 OR @@ROWCOUNT <> 1
							BEGIN
								...
								RETURN;
							END
						-- Incremento na variável de contagem de apartamentos
						SET @ContagemApartamento += 1;
					END

				SET @ContagemApartamento = 1;
				-- Incremento na variável de contagem de pavimentos
