CREATE OR ALTER PROCEDURE [dbo].[SP_InserirDespesa]	@IdTipo TINYINT,
	...
	/*
		...
		Ex................: BEGIN TRAN
							...
							RETORNOS: ........: 0 - SUCESSO
												1 - NÃO É POSSIVEL INSERIR DESPESA COM DIFERENÇA DE TEMPO MAIOR QUE 30 DIAS
												2 - ERRO AO INSERIR UMA DESPESA
	*/
	BEGIN
		--LIMITA O INSERT ATÉ 30 DIAS ANTERIORES AO DIA EM QUESTÃO
...
CREATE OR ALTER PROCEDURE [dbo].[SP_ListarDespesas]	
	...
	*/
	BEGIN
		--SELECIONA TODAS AS DESPESAS COM PERÍODO DE VENCIMENTO ENTRE DUAS DATAS
		SELECT	td.Nome,
				d.Descricao,
				d.Valor,
				d.DataVencimento
