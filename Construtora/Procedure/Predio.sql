CREATE OR ALTER PROCEDURE [dbo].[SP_InserirPredio]
	...
	/*
		...
		Objetivo........:	Cria registro de prédio e ao mesmo tempo cria todos os apartamentos
		...
		BEGIN TRANSACTION
			BEGIN TRY
				...
				INSERT INTO [dbo].[Predio]	(
					...
					-- Captura IdPredio que acabou de ser gerado
...
CREATE OR ALTER PROCEDURE [dbo].[SP_EntregarPredio]
	...
	/*
		Documentacao
		Arquivo fonte...:	Predio.sql
		Objetivo........:	Atualiza atributo 'Entregue' do prédio para TRUE
		Autor...........:	Grupo Estagiários SMN
		Data............:	10/05/2024
		Exemplo.........:	BEGIN TRANSACTION
								DBCC DROPCLEANBUFFERS;
	...
	*/
	BEGIN
		-- Verificação se o prédio passado por parâmetro existe no banco de dados
		...
		-- Atualiza atributo de 'Entregue' do Prédio passado por parâmetro
		UPDATE [dbo].[Predio]
			SET Entregue = 1
			WHERE Id = @IdPredio
		RETURN 0
