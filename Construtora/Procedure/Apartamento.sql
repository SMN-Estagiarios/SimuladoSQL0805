CREATE OR ALTER PROC [dbo].[SP_RelatorioAptoVendidos]
	...
	/*
		...
		Objetivo..........: Listar todos os apartamentos com as informações de parcelas pagas, vencidas e vincendas
	...
	*/
	BEGIN
		-- Declarando variável da data atual
		DECLARE @DataAtual DATE = GETDATE();
		
		-- Recuperando dados da subquery e calculando também a quantidade de parcelas restantes
