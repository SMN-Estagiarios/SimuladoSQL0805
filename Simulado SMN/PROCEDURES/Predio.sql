		...
		BEGIN TRANSACTION
			BEGIN TRY
				...
				INSERT INTO [dbo].[Predio]	(
					...
					-- Capturando IdPredio que acabou de ser gerado
...
CREATE OR ALTER PROCEDURE [dbo].[SP_EntregarPredio]
	...
	Ex.......................:	BEGIN TRANSACTION
									...
									EXEC @RET = [dbo].[SP_EntregarPredio] 1
	...
	*/
	BEGIN
		-- Verificando se o predio passado por parametro existe no banco de dados
...
CREATE OR ALTER PROCEDURE [dbo].[SP_ListarPredio]
	...
	Documentacao
	Arquivo fonte............:	Predio.sql
	Objetivo.................:	Lista todos os predios
	Autor....................:	Grupo de Estagiarios SMN
	Data.....................:	10/05/2024
	Ex.......................:	BEGIN TRANSACTION
									DBCC DROPCLEANBUFFERS;
